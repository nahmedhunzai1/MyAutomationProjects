...
@Given(u'User opens Konsuld URL with cookies-ch')
def step_impl(context):
    ...
    email_field.send_keys('later-middle@utn6ssz5.mailosaur.net')
    ...
    api_key = "eDcDlo18yMa9k0LY2TlzfkV8ehnBc2Cz"
    server_id = "utn6ssz5"
    server_domain = "utn6ssz5.mailosaur.net"

    mailosaur = MailosaurClient(api_key)
    criteria = SearchCriteria()
    criteria.sent_to = "later-middle@" + server_domain
    ...
    pickle.dump(auth_token, open("../test-cases/chndler.pkl","wb"))
